...
local scripting_rc_1 = rc:find_channel_for_option(301)
local scripting_rc_2 = rc:find_channel_for_option(300) -- this is the switch mapped to 300 for us this is Channel 7
local flip_flop = 0
